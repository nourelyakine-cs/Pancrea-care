...
class PatientListItemRead(PatientRead):
    """Patient du listing + dernier bilan clinique (stade/TNM le plus récent)."""

    id_dossier: int | None = None
    id_evaluation: int | None = None
    date_derniere_evaluation: date | None = None
